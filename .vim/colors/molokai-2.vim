...
set t_Co=256
let colors_name = "molokai-2"

hi Comment	    guifg=#919191    ctermfg=245    gui=bold    cterm=bold 
hi Constant	    guifg=#8eb872    ctermfg=245    gui=none    cterm=none 
...
hi Identifier	    guifg=#91ced6    ctermfg=245    gui=none    cterm=none 
hi LineNr	    guifg=#8a8a8a    ctermfg=245    gui=none    cterm=none 
hi MatchParen	    guifg=#ccffcc    ctermfg=252    guibg=#008b8b    ctermbg=33    gui=none    cterm=none 
hi Normal	    guifg=#e6e6e6    ctermfg=254    guibg=#333333    ctermbg=237    gui=none    cterm=none 
...
hi PreProc	    guifg=#fccfcf    ctermfg=196    gui=none    cterm=none 
hi Statement	    guifg=#c9c9c9    ctermfg=251    gui=none    cterm=none 
hi Special	    guifg=#757475    ctermfg=242    gui=none    cterm=none 
...
hi Type	    guifg=#9bbedb    ctermfg=247    gui=bold    cterm=bold 
